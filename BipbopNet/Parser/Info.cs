...
namespace BipbopNet.Parser
{
    ...
    public class Info : BipbopDocument
    {
        ...
        public TableDescription findTable(string targetDatabase, string targetTable) {
            ...
            var database = Databases.First(databaseDescription => string.Compare(databaseDescription.Name, targetDatabase, StringComparison.OrdinalIgnoreCase) == 0);
            return database.Tables.First(tableDescription => string.Compare(tableDescription.Name, targetTable, StringComparison.OrdinalIgnoreCase) == 0);
        }
