...
namespace BipbopNet.Parser
{
    public class Processo : BipbopDocument
    {
        ...
        /// <summary>
        ///     Corresponde ao território em que o juiz de primeiro grau irá exercer sua jurisdição e pode abranger um ou mais
        ///     municípios
        /// </summary>
        ...
        /// <summary>
        ///     Fase: momento processual. Existem duas essenciais de conhecimento (fase decisória) e de execução (cumprimento de
        ///     sentença).
        /// </summary>
        public string Fase => _processoNode.SelectSingleNode("./fase")?.InnerText;

        /// <summary>
        ///     Incidente processual é uma questão controversa secundária e acessória que surge no curso de um processo e que
        ///     precisa ser julgada antes da decisão do mérito da causa principal.
        /// </summary>
